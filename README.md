...
[![Mod Version](https://img.shields.io/badge/version-3.5.1-blue.svg)](https://github.com/fodoth/neoguanniao)
...
- Minecraft: **1.21.1**
- NeoForge: **21.1.233+**（对应 `neoguanniao-3.5.1-1.21.1-neoforge.jar`）
- Fabric: **Fabric Loader 0.17.0+** + Fabric API（对应 `neoguanniao-3.5.1-1.21.1-fabric.jar`）
...
4. 按加载器选择 `neoguanniao-3.5.1-1.21.1-neoforge.jar` 或 `neoguanniao-3.5.1-1.21.1-fabric.jar`，放入 `.minecraft/mods`
5. 启动游戏

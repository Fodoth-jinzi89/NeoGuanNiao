...
public final class CrowEntity extends SimpleNeoBirdEntity<CrowEntity> {
   public CrowEntity(EntityType<CrowEntity> type, Level level) {
      super(type, level, (BirdData)BirdCameraBirdData.CROW);
   }

   protected CrowEntity getSelf() {
      return this;
   }
   ...
   public static boolean canSpawn(
      ...
      return SimpleNeoBirdEntity.canSpawn(type, level, spawnType, pos, random, (BirdData)BirdCameraBirdData.CROW);
   }
}

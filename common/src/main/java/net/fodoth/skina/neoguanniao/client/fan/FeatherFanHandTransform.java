...
public final class FeatherFanHandTransform {
    private FeatherFanHandTransform() {}

    public static boolean apply(@NotNull PoseStack poseStack, @NotNull LocalPlayer player, @NotNull HumanoidArm arm, @NotNull ItemStack itemInHand, float partialTick, float equipProgress) {
        ...
        float chargeEase = FeatherFanHandTransform.smootherStep(chargeProgress);
        float progress = FeatherFanHandTransform.getDampedPoseProgress(elapsedTicks);

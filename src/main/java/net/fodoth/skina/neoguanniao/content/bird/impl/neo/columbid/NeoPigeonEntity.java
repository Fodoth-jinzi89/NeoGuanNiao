...
import net.fodoth.skina.neoguanniao.content.bird.impl.old.columbid.PigeonProfile;
...
public class NeoPigeonEntity extends AbstractBirdEntity<NeoPigeonEntity> {

    public NeoPigeonEntity(EntityType<NeoPigeonEntity> entityType, Level level) {
        super(
                entityType,
                level,
                NeoGuanNiaoBirdData.PIGEON.get(),
                BirdControllers.<NeoPigeonEntity>builder().birdAnimationController(new BirdAnimationController<>(){
                    @Override
    ...
    @Override
    protected NeoPigeonEntity getSelf() {
        return this;
    }
    ...
    public static boolean canSpawn(
        ...
        int entityCount = level.getEntitiesOfClass(NeoPigeonEntity.class, searchBox).size();

...
public record BirdFlyingDatum(
    ...
    public BirdFlyingDatum withFlightProfile(BirdFlightProfile flightProfile) {
        return new BirdFlyingDatum(
                ...
                minimumFlightTicks,
                airborneGraceTicks,
                ambientAirCruiseMinTicks,
                ambientAirCruiseRandomTicks,
                escapeAirCruiseMinTicks,
                escapeAirCruiseRandomTicks,
                minFlybyDuration,
                flybyDurationVariance,
                flybyHorizontalSpeed,
                flybyUpwardSpeed,
                minHoverRetargetTicks,
                hoverRetargetTicksVariance,
                hoverRetargetMinDelay,
                hoverRetargetDelayVariance,
                birdBathMountHorizontalSpeed,
                birdBathMountUpwardSpeed,
                birdBathMountFlightTicks,
                shortFlyTicks,
                shortFleeTicks,
                escapeFlightMinDistance,
                escapeFlightDistanceVariance,
                ...
                unsafeLandingCruiseMinDuration,
                unsafeLandingCruiseDurationVariance,
                unsafeLandingCruiseStateTicks,
                cruiseLookChanceDenominator,
                cruiseFallbackHeightGround,
                cruiseFallbackHeightAir,
                landingSharedRadius,
                landingSharedVerticalRange,
                landingSurfaceSearchRadius,
                landingRandomAttempts,
                landingRandomHorizontalRange,
                flightTargetMinHeightOffset,
                flightTargetMaxHeightOffset,
                waterEscapeMinDuration,
                waterEscapeRandomDuration,
                waterEscapeBehaviorTicks,
                waterEscapeHorizontalSpeed,
                waterEscapeVerticalSpeed,
                waterEscapeHoverRetargetMin,
                waterEscapeHoverRetargetMax,
                flightTargetReachDistance,
                flightLandingReachDistance,
                flightMovementScale,
                flightDesiredScale,
                flightStalledThreshold,
                flightStalledMinSpeed,
                flightStalledVerticalBoost,
                flightEscapeSpeed,
                flightLandingSpeed,
                flightAmbientSpeed,
                flightLandingDecalDistance,
                flightLandingDecalFactor,
                flightHoverBobAmplitude,
                flightHoverBobFrequency,
                flightLandingHoverBob,
                flightVerticalClampMin,
                flightVerticalClampMax,
                flightVerticalAmbientMin,
                flightVerticalAmbientMax,
                flightVerticalLandingFactor,
                flightVerticalAmbientFactor,
                flockRange,
                flockSeparation,
                flockAlignment,
                flockCohesion,
                ...
                flockAmbientWeight,
                flockWeightEscape,
                ambientAirCruiseChanceTame,
                ambientAirCruiseChanceWild
        );
    }
}
...
public class BudgerigarSentinelGoal extends Goal {
    ...
    public boolean canUse() {
        return this.budgerigar.getRoutineController().isActiveTime()
    ...
    public void start() {
        ...
        this.budgerigar.getBehaviorStateController().setBehaviorState(BirdBehaviorState.SENTINEL);
    ...
    public void stop() {
        ...
        if (this.budgerigar.getBehaviorStateController().getBehaviorState() == BirdBehaviorState.SENTINEL) {

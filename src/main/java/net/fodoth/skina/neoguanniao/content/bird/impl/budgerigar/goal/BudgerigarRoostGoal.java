...
public class BudgerigarRoostGoal extends Goal {
    ...
    public boolean canUse() {
        if (!this.budgerigar.isRoostTime() || this.budgerigar.isEating() || this.budgerigar.isDancing()) {
            return false;
        }
    ...
    public boolean canContinueToUse() {
        return this.roostPos != null && this.budgerigar.isRoostTime()
    ...
    public void stop() {
        this.roostPos = null;
        this.repathTicks = 0;
        if (this.budgerigar.getBehaviorState() == BudgerigarBehaviorState.ROOSTING
                || this.budgerigar.getBehaviorState() == BudgerigarBehaviorState.SLEEPING) {

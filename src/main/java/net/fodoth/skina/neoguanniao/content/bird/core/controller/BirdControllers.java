...
public final class BirdControllers<T extends AbstractBirdEntity<T>> {
    ...
    public static final class Builder<T extends AbstractBirdEntity<T>> {
        ...
        public Builder<T> birdFeatherController(BirdFeatherController<T> controller) {
        ...
        public Builder<T> birdModelController(BirdModelController<T> controller) {
